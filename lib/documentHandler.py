...
class DocumentHandler:
    ...
    def __new__(self,path):
        ...
        if not path or "." not in path or len(pathls) > 2:
            ...
            raise DocumentHandlerException("Path format is invalid! "+path)
            ...
            if extension not in constantVariables.VALID_EXTENSIONS:
                ...
                raise DocumentHandlerException ("The given file extension "+pathls[1].lower()+" is not supported. "+"The valid extensions are: "+str(constantVariables.VALID_EXTENSIONS))
